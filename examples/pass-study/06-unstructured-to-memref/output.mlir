...
module {
  tt.func public @add_kernel_01234(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: !tt.ptr<f32>, %arg3: i32) {
    ...
    linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel"]} ins(%7, %16, %9 : tensor<1024xi32>, tensor<1024xf32>, tensor<1024xi1>) {
    ^bb0(%in: i32, %in_2: f32, %in_3: i1):
      scf.if %in_3 {
        %17 = arith.index_cast %in : i32 to index
        memref.store %in_2, %cast_1[%17] : memref<?xf32>
      }
      linalg.yield
    }
    tt.return
